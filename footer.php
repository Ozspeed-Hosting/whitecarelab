            ...
            <div class="col-sm-12 col-md-12 col-lg-3">
              <div class="footer-widget-contact">
                ...
                <ul class="contact-list list-unstyled">
                  <li>
                    <a href="mailto:Info@whitecarelab.com">
                      <i class="contact-icon icon-email"></i> <span>Info@whitecarelab.com</span>
                    </a>
                  </li>
                  <li>
                    <a href="tel:+919601583981 ">
                      <i class="contact-icon icon-phone"></i> <span>+919601583981 </span>
                    </a>
                  </li>
                </ul>
                <p>220 Ganesh Imperial RAF camp SP Ring Road Vastral Ahmedabad</p>
                <a href="contact-us.php" class="btn btn-white btn-link mr-30">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
              <div class="footer-widget-time">
                ...
                <div class="d-flex align-items-center">
                  <a href="contact-us.php" class="btn btn-primary btn-block">
          ...
          <div class="row align-items-center">
            <div class="col-12 d-flex flex-wrap">
              ...
              <div>
                ...
                <div class="mt-1 ">
                  <span>&copy; 2024 Whitecarelab, All Rights Reserved.</span>
                  <a class="color-secondary" href="http://ozspeed.in">ozspeed.in</a>
                </div>
              </div>
            </div><!-- /.col-lg-6 -->
          </div><!-- /.row -->
