...
<head>
  ...
  <title>Provetta - Laboratory & Science Research HTML5 Template</title>
            ...
            <div class="col-12">
              <div class="d-flex align-items-center justify-content-between">
                <ul class="contact-list d-flex flex-wrap align-items-center list-unstyled mb-0">
                  <li>
                    <i class="icon-phone"></i><a href="tel:+919601583981">Emergency Line: +919601583981 </a>
                  </li>
                  <li>
                    <i class="icon-location"></i><a href="contact-us.php">Location: 220 Ganesh Imperial RAF camp SP Ring Road Vastral Ahmedabad</a>
                  </li>
                  <li>
          ...
          <div class="collapse navbar-collapse justify-content-center" id="mainNavigation">
            <ul class="navbar-nav">
              ...
              <li class="nav-item has-dropdown has-mega-dropdown">
                <a href="tests-services.php" class=" nav-item-link">Tests & Services</a>



              </li><!-- /.nav-item -->
              <li class="nav-item">
                <a href="contact-us.php" class="nav-item-link">Contacts</a>
              </li><!-- /.nav-item -->
            ...
            <ul class="header-actions d-flex align-items-center position-relative list-unstyled mb-0">
              <li class="d-none d-xl-flex align-items-center">
                <a href="contact-us.php" class="btn btn-primary btn-outlined btn-contact">
                  Book a Lab Visit
                </a>
              </li>
          ...
          <div class="d-none d-xl-flex align-items-center position-relative ml-30">
            <div class="contact-phone d-flex align-items-center">
              ...
              <div>
                ...
                <a class="phone-link d-block" href="tel:+919601583981 ">+919601583981 </a>
              </div>
            </div>
          </div>
        </div><!-- /.container -->
